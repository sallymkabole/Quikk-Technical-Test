        ...
        <v-card flat style="background: transparent" width="75%" height="100%">
            ...
            <v-layout wrap style class="">
                            ...
                            <v-flex xs12 sm12 md8 lg8 class="pt-4 pb-4">
                                ...
                                <v-form v-model="valid">
                                    ...
                                    <v-text-field dense v-model="userInfo.top_amount" :rules="[num_rules]" min="50"
                                        ref="input" type="number" class="box" color="#335eea" outlined></v-text-field>
                                    <v-row>
                ...
                " v-model="userInfo.my_phone" v-bind="bindProps" v-on:country-changed="countryChanged"></vue-tel-input>
                                    ...
                                    <v-btn class="btn1" large rounded block color="#335eea" @click="deposit"
                                        :disabled="!valid">
                                        Top Up </v-btn>
                                </v-form>
                ...
                <v-flex xs12 sm12 md8 lg8>
                    <v-card height="100%" class="d-flex flex-direction-column login-card">
                        ...
                        <v-layout style="display=flex;justify-content: center;align-items: center;flex-direction: column;" class="auth-card my-auto">
                            <v-flex xs12 sm12 md8 lg8 class="mx-auto my-auto">


                                <v-layout column class="mb-8">


                                    <v-card flat color="#fff" class="d-flex " width="100%" height="100%"
                                        style="padding: 1px; border-radius: 8px">
                                        <v-layout wrap row class="mt-4">
                                            <v-layout column style="width: 100%; padding: 5px"
                                                v-for="transaction in my_transactions" :key="transaction.title">
                                                <v-layout style="display: flex; justify-content: space-around;padding: 2px;" wrap>
                                                    <v-flex xs12 sm4 md4 lg4>
                                                        <v-avatar class="mr-6" color="indigo">
                                                            <v-icon dark>
                                                                mdi-account-circle
                                                            </v-icon>
                                                        </v-avatar>
                                                    </v-flex>
                                                    <v-flex xs12 sm12 md4 lg4><span style="width: 100%" class="">
                                                    ...
                                                    <v-flex xs12 sm12 md4 lg4>
                                                        <span class="subheading mr-2 ">
                                                            <v-span class="d-flex d-inline-flex"
